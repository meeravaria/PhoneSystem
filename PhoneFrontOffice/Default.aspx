...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblError" runat="server" BackColor="White" Font-Bold="True" Font-Size="Medium" style="z-index: 1; left: 290px; top: 73px; position: absolute; height: 110px; width: 304px; bottom: 481px;" Text="lblError"></asp:Label>
        <asp:Label ID="lblPleaseEnter" runat="server" Font-Bold="True" style="z-index: 1; left: 26px; top: 392px; position: absolute; width: 223px" Text="Please Enter a Make"></asp:Label>
