...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 145px; top: 427px; position: absolute; height: 28px; width: 55px;" Text="Apply" OnClick="btnApply_Click" BackColor="#FFB7B7" Font-Bold="True" />
