...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblPleaseEnter" runat="server" style="z-index: 1; left: 32px; top: 362px; position: absolute; width: 207px" Text="Please enter a postcode..."></asp:Label>
        <asp:TextBox ID="txtStaffSearch" runat="server" style="z-index: 1; left: 33px; top: 392px; position: absolute; width: 220px"></asp:TextBox>
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 32px; top: 430px; position: absolute" Text="Apply" OnClick="btnApply_Click" />
